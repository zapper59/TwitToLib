...
public class WordSet {
	...
	public String randomPluralNoun() {
		if (counts[1] == 0)
			return "";
		int randomInt = (int) (Math.random() * (counts[1]-1));
		int i = 0;
		for (; randomInt > 0; i++) {
	...
	public String randomVerb() {
		if (counts[2] == 0)
			return "";
		int randomInt = (int) (Math.random() * (counts[2]-1));
		int i = 0;
		for (; randomInt > 0; i++) {
	...
	public String randomPastVerb() {
		if (counts[3] == 0)
			return "";
		int randomInt = (int) (Math.random() * (counts[3]-1));
		int i = 0;
		for (; randomInt > 0; i++) {
	...
	public String randomAdverb() {
		if (counts[4] == 0)
			return "";
		int randomInt = (int) (Math.random() * (counts[4]-1));
		int i = 0;
		for (; randomInt > 0; i++) {
	...
	public String randomAdjective() {
		if (counts[5] == 0)
			return "";
		int randomInt = (int) (Math.random() * (counts[5]-1));
		int i = 0;
		for (; randomInt > 0; i++) {
	...
	public String randomNumber() {
		if (counts[6] == 0)
			return "";
		int randomInt = (int) (Math.random() * (counts[6]-1));
		int i = 0;
		for (; randomInt > 0; i++) {
